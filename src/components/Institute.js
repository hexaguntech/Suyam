  ...
  render() {
    return <div className="institute">
      ...
      <div className="content3">
        <p>In 2009, joining hands with Pondicherry Institute of Development, Research and Action (founded by renowned Economist and Politician, Professor M. RAMADASS), Suyam I.A.S. Coaching Institute trained needy aspirants for the recruitment exams for the posts of Village Administrative  Officer (VAO) and Village Assistant (VA) for a meagre fee to run the show.  Out of the 30 aspirants, the most needy 10 had cried in happiness when they knew that they became bread winners for their families. 
        <br /><br />Since then, the Institute has preferred creating bread winners to achieving its dream.
        Till this date, the Institute has bred more than 600 breadwinners in various positions like Deputy Tahsildar, Village Administrative Officer, Village Assistant, Upper Division Clerk, Lower Division Clerk, Sub Inspector of Police, Police Constable (Men / Women / IRBn), Jail Warder, Fireman, Home Guard, Welfare Inspector, Assistant Commercial Tax Officer in the Government of Puducherry.  That at-least a fourth in every Selection List will be Suyamites is not uncommon since 2009.  
        </p>
      </div>
      <div className="content4">
        <p>Name a Department in Puducherry; you can find tens of Suyamites there.
        Suyam Institute is not only preparing Suyamites to be breadwinners, but also as socially responsible and humanitarian Samaritans.  Suyamites have shown, ever and anon, their compassion in serving the humanity.  To quote a few —
        </p>
      </div>
      ...
      <div className="content6">
        <p>Suyam is not a mere institute, it is a <b>“movement”</b>.<br /><br />
            ...
            The virtual class room and exam hall in this site will be a great boon to those aspirants who have compelling reasons that limit them from having tryst with the conventional chalkboard class room of suyam institute.  Working people, pregnant women, college going students, physically challenged persons and the like can make use of this online facility. <br /><br />

            The institute has committed to pave an easy track for the aspirants by giving them an effective coaching.  <br /><br />

            and, the time is not too far off when suyam i.a.s. coaching institute shall realise its dream of fostering civil servants in large numbers. <br /><br />

            <span><b>If you have the will to achieve,<br/>
            We are here to show you the way.</b></span>
        </p>
      </div>
    </div>;
  }
