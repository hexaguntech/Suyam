    ...
    return (
      <div className="container mt3 redkepi">
        ...
        <p>
          ...
          aspirants to turn their Khakhi dreams into reality.
        </p>
        <p>
          As per the recruitment procedure for the posts of Police Constable,
          all candidates (male or female) who qualify the Physical standards and
          Physical Efficiency tests, shall undergo a Witten test. The questions
          will be of objective type and will be generally of S.S.L.C. Standard.
          The question paper will be in two parts each of two hours duration,
          consisting of
        </p>
        <br />
        <h5>
          ...
          <p>
            ...
            <ul>
              <li>
                <span>
                  <b style={{ color: `#0a79df` }}>
                    Well delivered VIDEO CLASSES
                  </b>{' '}
                  – Dedicated faculty of the institute give importance to
                  Conceptual clarity and innovative delivery of subjects.
                </span>
              </li>
              ...
              <li>
                <span>
                  <b style={{ color: `#0a79df` }}>
                    Meticulously crafted E-NOTES
                  </b>{' '}
                  – Current affairs will be updated on weekly basis and General
                  Knowledge and other materials considered to be helpful will be
                  provided.
                </span>
              </li>
              ...
              <li>
                <span>
                  <b style={{ color: `#0a79df` }}>
                    Carefully prepared DAILY TESTS and WEEKLY TESTS
                  </b>{' '}
                  – This most powerful online assessment tool gives you an
                  exceptional and seamless online exam experience through Daily
                  Tests and Weekly Tests based on the subjects covered,
                  regularly.
                </span>
              </li>
            </ul>
            Besides the above learning tools, well edited, exam oriented and
            bilingual (both in English and Tamil) books on the required subjects
            based on the Tamil Nadu Text Books (6 th to 10 th Standard) will be
            provided.
          </p>
          <br />
        </div>
        ...
        <h4>
          Course Fee :{' '}
          <b style={{ color: `#0a79df`, fontWeight: `500` }}>Rs.7500</b>
        </h4>
