      ...
      <Page style={styles.page}>
        {
          <View>
            ...
            <Text style={{ textAlign: 'center' }}>My Application</Text>
            <Image
              source={photoLink}
              style={{
                width: `100px`,
            ...
            >
              {' '}
              My Address is {addressLine1}, {addressLine2}, {state}, {pincode}.{' '}
            </Text>
            <Text
              style={{
                margin: 4,
            ...
            >
              {' '}
              My Additional qualifications are {additionalQualification}{' '}
            </Text>
            <Text
              style={{
                margin: 4,
